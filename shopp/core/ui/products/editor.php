...
add_meta_box('save-product', __('Save','Shopp'), 'save_meta_box', 'product', 'side', 'core');
...
add_meta_box('categories-box', __('Categories','Shopp'), 'categories_meta_box', 'product', 'side', 'core');
...
add_meta_box('product-tags', __('Tags','Shopp'), 'tags_meta_box', 'product', 'side', 'core');
...
add_meta_box('settings-tags', __('Settings','Shopp'), 'settings_meta_box', 'product', 'side', 'core');
...
add_meta_box('product-summary', __('Summary','Shopp'), 'summary_meta_box', 'product', 'normal', 'core');
...
add_meta_box('product-details-box', __('Details &amp; Specs','Shopp'), 'details_meta_box', 'product', 'normal', 'core');
...
add_meta_box('product-images', __('Product Images','Shopp'), 'images_meta_box', 'product', 'normal', 'core');
...
add_meta_box('product-pricing-box', __('Pricing','Shopp'), 'pricing_meta_box', 'product', 'advanced', 'core');



do_action('do_meta_boxes', 'product', 'normal', $Product);
do_action('do_meta_boxes', 'product', 'advanced', $Product);
do_action('do_meta_boxes', 'product', 'side', $Product);
?>
<div class="wrap shopp"> 
	...
	<form name="product" id="product" action="<?php echo $Shopp->wpadminurl; ?>/admin.php" method="post">
		...
		<div id="poststuff" class="metabox-holder">
			...
			$side_meta_boxes = do_meta_boxes('product', 'side', $Product);
			...
			<?php
			do_meta_boxes('product', 'normal', $Product);
			do_meta_boxes('product', 'advanced', $Product);
			?>
