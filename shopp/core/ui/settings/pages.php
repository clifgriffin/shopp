<div class="wrap shopp">
	...
	<tr class="inline-edit-row ${classnames}" id="${id}">
		<td>
		<fieldset><label><input type="text" name="settings[storefront_pages][${name}][title]" value="${title}" /><br /><?php _e('Title','Shopp'); ?></label></fieldset>
		<p class="submit">
		<a href="<?php echo $this->url; ?>" class="button-secondary cancel"><?php _e('Cancel','Shopp'); ?></a>
		</p>
		</td>
		<td class="slug column-slug">
		<fieldset><label><input type="text" name="settings[storefront_pages][${name}][slug]" value="${slug}" /><br /><?php _e('Slug','Shopp'); ?></label></fieldset>
		<p class="submit">
