		...
		refundbtn = $('#cancel-order, #refund-button').click(function (e) {
			...
			var $this = $(this).hide(),
				data = ('refund-button' == $this.attr('id') ?
						{ action:'refund',title:$om.ro,cancel:$om.cancel,process:$om.pr,reason: $om.rr } :
						{ action:'cancel',title:$om.co,cancel:$om.dnc,process:$om.co,reason: $om.rc,disable_amount: ' disabled="disabled"' }),
