...
class OrderAmount {
	...
	function methods (&$ShipCalc) {
		$ShipCalc->methods[get_class($this).'::range'] = "Order Amount Tiers";
	}
...
var OrderAmountRange = function (methodid,table,rates) {
	...
	$('<th scope="col" class="units"><label for="max-'+methodid+'-0">By Order Amount</label></th>').appendTo(headingsRow);
