...
<p>
	...
	<input type="text" name="username" id="username" value="<?php echo $wp_user->user_login; ?>" size="24" readonly="readonly" class="clickable" rel="<?php echo add_query_arg('user_id',$Customer->wpuser,admin_url('user-edit.php')); ?>" /><br />
