<div class="wrap shopp">
	...
	<tr class="inline-edit-row ${classnames}" id="${id}">
		...
		<table id="taxrate-editor">
			...
			<?php
				$options = array('any' => Shopp::__('any'), 'all' => strtolower(__('All')));
			...
			<tr>
				<td colspan="3">
				<p class="textright">
				<a href="<?php echo $this->url; ?>" class="button-secondary cancel alignleft"><?php _e('Cancel'); ?></a>
	...
	<table class="widefat" cellspacing="0">
		...
		<tr class="<?php echo join(' ',$classes); ?>" id="taxrates-<?php echo $index; ?>">
			<td class="name column-name"><a href="<?php echo esc_url($editurl); ?>" title="<?php _e('Edit'); ?> &quot;<?php echo esc_attr($rate); ?>&quot;" class="edit row-title"><?php echo esc_html($label); ?></a>
