	...
	<form name="settings" id="system" action="<?php echo esc_url($_SERVER['REQUEST_URI']); ?>" method="post">
		...
		<table class="form-table"> 
			...
			<tr class="form-required"> 
				...
				<td><button type="submit" id="rebuild-index" name="rebuild" class="button-secondary"><?php _e('Rebuild Product Search Index','Shopp'); ?></button><br /> 
			...
			<tr class="form-required"> 
				...
				<td><button type="button" id="image-cache" name="rebuild" value="true" class="button-secondary"><?php _e('Delete Cached Images','Shopp'); ?></button><br />
