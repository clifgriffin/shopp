...
(function($) {
	...
	var ajaxurl = '<?php echo wp_nonce_url($Shopp->siteurl."/wp-admin/admin-ajax.php", "shopp-wp_ajax_shopp_update"); ?>';
	var adminurl = '<?php echo wp_nonce_url($Shopp->siteurl."/wp-admin/admin.php", "shopp-wp_ajax_shopp_update"); ?>';
