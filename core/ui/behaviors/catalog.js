...
function validate (form) {
	...
	$.each(inputs.reverse(),function (id,field) {
		...
		if (input.hasClass('email') && !input.val().match( // RFC 822 Email validation
			 new RegExp('([^\\x00-\\x20\\x22\\x28\\x29\\x2c\\x2e\\x3a-\\x3c\\x3e\\x40\\x5b-\\x5d\\x7f-\\xff]+|\\x22([^\\x0d'+
						...
						'|\\x5c[\\x00-\\x7f])*\\x5d))*'))) error = new Array($cv.email,field);
