	...
	function logins () {
		...
		switch ($authentication) {
			case "wordpress":
				...
				if (empty($_POST['process-login']) || $_POST['process-login'] == 'false') return false;
		...
		switch ($property) {
			...
			case "password":
				if ($options['mode'] == "value") 
					return strlen($this->data->Order->Customer->password) == 34?str_pad('&bull;',8):$this->data->Order->Customer->password;
